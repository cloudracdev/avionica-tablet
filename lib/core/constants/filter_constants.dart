...
///
/// **EMA Formula:** S_t = Î± * Y_t + (1 - Î±) * S_{t-1}
/// - Î± (alpha): Smoothing factor (0.0 - 1.0)
///   - Higher Î± = more responsive (less smoothing)
///   - Lower Î± = more smoothing (less responsive)
///
...
///
/// âš¡ HIGH RESPONSIVENESS MODE - Quick instrument response
class FilterConstants {
  ...
  static const double alphaLat = 0.4;

  /// Smoothing factor for GPS longitude
  /// 0.7 = Responsive position updates
  static const double alphaLng = 0.4;

  /// Smoothing factor for X-axis acceleration (g)
  /// 0.8 = Very responsive
  static const double alphaAccelX = 0.5;

  /// Smoothing factor for Y-axis acceleration (g)
  /// 0.8 = Very responsive
  static const double alphaAccelY = 0.5;
  ...
  static const double deadZoneVelocidade = 0.5;
  ...
  static const double deadZoneHeading = 1.0;
  ...
  static const double deadZoneVario = 0.1;

  /// Dead zone for temperature (Â°C)
  /// Ignore changes < 0.5Â°C
  static const double deadZoneTemperatura = 1.0;

  /// Dead zone for pressure (Pa)
  /// Ignore changes < 20 Pa
  static const double deadZonePressao = 50.0;

  /// Dead zone for GPS latitude
  /// Ignore changes < 0.00001 degrees (~1 meter)
  static const double deadZoneLat = 0.00005;

  /// Dead zone for GPS longitude
  /// Ignore changes < 0.00001 degrees (~1 meter)
  static const double deadZoneLng = 0.00005;

  /// Dead zone for X-axis acceleration (g)
  /// Ignore changes < 0.02g
  static const double deadZoneAccelX = 0.05;

  /// Dead zone for Y-axis acceleration (g)
  /// Ignore changes < 0.02g
  static const double deadZoneAccelY = 0.05;
}